define([
    ...
    window.SettingsLogClearing = Class.create(Common, {
        ...
        initialize: function () {
            jQuery.validator.addMethod('TikTokShop-logs-clearing-interval', function (value, el) {

                if (jQuery.validator.methods['TikTokShop-required-when-visible'](null, el)) {
                    return true;
                }
                ...
                return true;
            }, TikTokShop.translator.translate('logs_clearing_keep_for_days_validation_message'));
        },
            ...
            self.confirm({
                actions: {
                    confirm: function () {
                        ...
                        SettingsObj.submitTab(TikTokShop.url.get('formSubmit', {
                            'task': 'clear_all',
                            'log': log
                        }), formData);
                    },
