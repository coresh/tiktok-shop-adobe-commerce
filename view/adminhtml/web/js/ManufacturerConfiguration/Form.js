define([
    ...
    window.ManufacturerConfigurationForm = Class.create({
        ...
        initialize: function(config) {
            ...
            this.selectedAccountId = config.accountId || null;
        ...
        initAccount: function() {
            $('#account_id').on('change', ()=> {
                this.setAccountId($('#account_id').val() || self.selectedAccountId);
            });
        ...
        renderResponsiblePersons: function(persons) {
            ...
            selects.each(function(index, select) {
                ...
                selectElement.append(persons.map(function(person) {
                    return new Option(person.title, person.id);
                }));

                if (ids !== null && ids.hasOwnProperty(index)) {
