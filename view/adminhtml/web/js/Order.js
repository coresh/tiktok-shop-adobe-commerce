define([
    ...
    Order = Class.create(Common, {
        ...
        createHelpTitleHtml: function (rowId) {
            ...
            var closeHtml = '<a href="javascript:void(0);" onclick="OrderObj.hideOrderHelp(' + rowId + ');" title="' + TikTokShop.translator.translate('Close') + '"><span class="hl_close icon-close"></span></a>';
        ...
        createHelpActionHtml: function (action) {
            ...
            } else if (action.type == TikTokShop.php.constant('M2E_TikTokShop_Model_Log_AbstractModel::TYPE_INFO')) {
            ...
            var type = '<span style="color: green;">' + TikTokShop.translator.translate('Success') + '</span>';
            if (action.type == TikTokShop.php.constant('M2E_TikTokShop_Model_Log_AbstractModel::TYPE_INFO')) {
                type = '<span style="color: blue;">' + TikTokShop.translator.translate('Info') + '</span>';
            } else if (action.type == TikTokShop.php.constant('M2E_TikTokShop_Model_Log_AbstractModel::TYPE_WARNING')) {
                type = '<span style="color: orange;">' + TikTokShop.translator.translate('Warning') + '</span>';
            } else if (action.type == TikTokShop.php.constant('M2E_TikTokShop_Model_Log_AbstractModel::TYPE_ERROR')) {
                type = '<span style="color: red;">' + TikTokShop.translator.translate('Error') + '</span>';
            }
        ...
        createHelpViewAllLogHtml: function (rowId, gridId) {
            let url = TikTokShop.url.get('tiktokshop_log_order/index', {id: rowId});

            return '<div class="hl_footer"><a target="_blank" href="' + url + '">' + TikTokShop.translator.translate('View Full Order Log') + '</a></div>';
        },
