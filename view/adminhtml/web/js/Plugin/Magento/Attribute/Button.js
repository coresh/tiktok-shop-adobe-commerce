define([
    ...
    window.MagentoAttributeButton = Class.create({
        ...
        _template: "<fieldset class='fieldset admin__fieldset  TikTokShop-fieldset'>" +
        ...
        init: function (element, callback) {
            ...
            var popup = jQuery(popupElement).modal({
                title: TikTokShop.translator.translate(
                ...
                buttons: [{
                    ...
                    text: TikTokShop.translator.translate('Insert'),
        ...
        _renderMagentoAttributes: function (containerElement) {
            ...
            var select = new Element('select',
                    _.extend({
                        ...
                        class: 'select admin__control-select TikTokShop-custom-attribute-can-be-created',
            ...
            containerElement.innerHTML = _.template(this._template)({
                id: 'magento-attribute-select-' + this._id,
                title: TikTokShop.translator.translate('Attribute'),
