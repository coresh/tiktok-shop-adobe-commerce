define([
    ...
    window.TikTokShopTemplateSellingFormat = Class.create(Common, {


        priceChangeIndex: 0,
        priceChangeTpl: '',

        constAbsoluteIncrease: TikTokShop.php.constant(
                '\\M2E\\TikTokShop\\Model\\Template\\SellingFormat::PRICE_COEFFICIENT_ABSOLUTE_INCREASE'
        ),
        constAbsoluteDecrease: TikTokShop.php.constant(
                '\\M2E\\TikTokShop\\Model\\Template\\SellingFormat::PRICE_COEFFICIENT_ABSOLUTE_DECREASE'
        ),
        constPercentageIncrease: TikTokShop.php.constant(
                '\\M2E\\TikTokShop\\Model\\Template\\SellingFormat::PRICE_COEFFICIENT_PERCENTAGE_INCREASE'
        ),
        constPercentageDecrease: TikTokShop.php.constant(
                '\\M2E\\TikTokShop\\Model\\Template\\SellingFormat::PRICE_COEFFICIENT_PERCENTAGE_DECREASE'
        ),
        constAttribute: TikTokShop.php.constant(
                '\\M2E\\TikTokShop\\Model\\Template\\SellingFormat::PRICE_COEFFICIENT_ATTRIBUTE'
        ),
        ...
        initialize: function () {
            var self = this;
            jQuery.validator.addMethod('TikTokShop-validate-price-coefficient', function (value, el) {
                ...
                var floatValidator = Validation.get('TikTokShop-validation-float');
                ...
                return true;
            }, TikTokShop.translator.translate('Price Change is not valid.'));

            jQuery.validator.addMethod('TikTokShop-validate-price-modifier', function (value, el) {
                if (self.isElementHiddenFromPage(el)) {
                    return true;
                }
        ...
        updateQtyPercentage: function () {
            ...
            if (qtyMode == TikTokShop.php.constant('\\M2E\\TikTokShop\\Model\\Template\\SellingFormat::QTY_MODE_NUMBER')) {
                return;
            }
        ...
        qty_mode_change: function () {
            var self = TikTokShopTemplateSellingFormatObj,
            ...
            if (this.value == TikTokShop.php.constant('\\M2E\\TikTokShop\\Model\\Template\\SellingFormat::QTY_MODE_NUMBER')) {
                customValueTr.show();
            } else if (this.value == TikTokShop.php.constant('\\M2E\\TikTokShop\\Model\\Template\\SellingFormat::QTY_MODE_ATTRIBUTE')) {
                self.selectMagentoAttribute(this, attributeElement);
            }

            maxPostedValueTr.hide();
            maxPostedValueMode.value = TikTokShop.php.constant('\\M2E\\TikTokShop\\Model\\Template\\SellingFormat::QTY_MODIFICATION_MODE_OFF');

            if (self.isMaxPostedQtyAvailable(this.value)) {

                maxPostedValueTr.show();
                maxPostedValueMode.value = TikTokShop.php.constant('\\M2E\\TikTokShop\\Model\\Template\\SellingFormat::QTY_MODIFICATION_MODE_ON');

                if (self.isMaxPostedQtyAvailable(TikTokShop.formData.qty_mode)) {
                    maxPostedValueMode.value = TikTokShop.formData.qty_modification_mode;
                }
            }
        ...
        isMaxPostedQtyAvailable: function (qtyMode) {
            return qtyMode == TikTokShop.php.constant('\\M2E\\TikTokShop\\Model\\Template\\SellingFormat::QTY_MODE_PRODUCT') ||
                    qtyMode == TikTokShop.php.constant('\\M2E\\TikTokShop\\Model\\Template\\SellingFormat::QTY_MODE_ATTRIBUTE') ||
                    qtyMode == TikTokShop.php.constant('\\M2E\\TikTokShop\\Model\\Template\\SellingFormat::QTY_MODE_PRODUCT_FIXED');
        },
        ...
        qtyPostedMode_change: function () {
            ...
            if (this.value == TikTokShop.php.constant('\\M2E\\TikTokShop\\Model\\Template\\SellingFormat::QTY_MODIFICATION_MODE_ON')) {
        ...
        fixed_price_mode_change: function (self) {
            ...
            attributeElement.value = '';
            if (this.value == TikTokShop.php.constant('\\M2E\\TikTokShop\\Model\\Template\\SellingFormat::PRICE_MODE_ATTRIBUTE')) {
                TikTokShopTemplateSellingFormatObj.selectMagentoAttribute(this, attributeElement);
            }
        },
        ...
        price_coefficient_mode_change: function () {
            ...
            if (this.value == TikTokShop.php.constant('\\M2E\\TikTokShop\\Model\\Template\\SellingFormat::PRICE_COEFFICIENT_NONE')) {
            ...
            if (this.value == TikTokShop.php.constant('\\M2E\\TikTokShop\\Model\\Template\\SellingFormat::PRICE_COEFFICIENT_ABSOLUTE_INCREASE')) {
                signSpan.innerHTML = '+';

                if (typeof TikTokShop.formData.currency != 'undefined') {
                    percentSpan.innerHTML = TikTokShop.formData.currency;
                }

                $(this.id.replace('coefficient_mode', '') + 'example_absolute_increase').show();
            }

            if (this.value == TikTokShop.php.constant('\\M2E\\TikTokShop\\Model\\Template\\SellingFormat::PRICE_COEFFICIENT_ABSOLUTE_DECREASE')) {
                signSpan.innerHTML = '-';
            ...
            if (this.value == TikTokShop.php.constant('\\M2E\\TikTokShop\\Model\\Template\\SellingFormat::PRICE_COEFFICIENT_PERCENTAGE_INCREASE')) {
                signSpan.innerHTML = '+';
                percentSpan.innerHTML = '%';
            ...
            if (this.value == TikTokShop.php.constant('\\M2E\\TikTokShop\\Model\\Template\\SellingFormat::PRICE_COEFFICIENT_PERCENTAGE_DECREASE')) {
                signSpan.innerHTML = '-';
                percentSpan.innerHTML = '%';
        ...
        checkMessages: function (data, container) {
            if (typeof TikTokShopListingTemplateSwitcherObj == 'undefined') {
                // not inside template switcher
                return;
            }

            var id = '',
                    nick = TikTokShop.php.constant('M2E_TikTokShop_Model_TikTokShop_Template_Manager::TEMPLATE_SELLING_FORMAT'),
                    storeId = TikTokShopListingTemplateSwitcherObj.storeId,
                    callback = function () {
