define([
    ...
    window.TikTokShopListingProductSettings = Class.create(Common, {

        // ---------------------------------------

        initialize: function () {
            jQuery.validator.addMethod('TikTokShop-validate-template-switcher', function (value, $element) {
        ...
        observeTemplate: function (id, add, edit, specify) {
            ...
            $(id).observe('change', function () {
                if (id == 'template_selling_format_id') {
                    TikTokShopListingProductSettingsObj.checkSellingFormatMessages();
                }
                TikTokShopListingProductSettingsObj.hideEmptyOption(this);
            });
            if ($(id).value) {
                $(id).simulate('change');
            }
        ...
        newShippingTemplateCallback: function () {
            ...
            TikTokShopListingProductSettingsObj.reload(TikTokShop.url.get('getShippingTemplates'), 'template_shipping_id');
        ...
        newReturnPolicyTemplateCallback: function () {
            ...
            TikTokShopListingProductSettingsObj.reload(TikTokShop.url.get('getReturnPolicyTemplates'), 'template_return_policy_id');
        ...
        newSellingFormatTemplateCallback: function () {
            ...
            TikTokShopListingProductSettingsObj.reload(TikTokShop.url.get('getSellingFormatTemplates'), 'template_selling_format_id');
        ...
        newDescriptionTemplateCallback: function () {
            ...
            TikTokShopListingProductSettingsObj.reload(TikTokShop.url.get('getDescriptionTemplates'), 'template_description_id');
        ...
        newSynchronizationTemplateCallback: function () {
            ...
            TikTokShopListingProductSettingsObj.reload(TikTokShop.url.get('getSynchronizationTemplates'), 'template_synchronization_id');
