define([
    ...
    class TikTokShopCategoryAttributeValidationPopup {
        constructor(config) {
        ...
        open(templateCategoryId) {
            ...
            let $modal = $('#modal_tts_category_attribute_validation');
            if (!$modal.length) {
                $modal = $('<div>', {id: 'modal_tts_category_attribute_validation'});
                $('body').append($modal);
            } else {
                $modal.empty();
            }
                ...
                success: function (response) {
                    ...
                    window.CategoryAttributeValidation = $modal.modal({
                        ...
                        modalCloseBtnHandler: function () {
                            self.executeClosePopupCallback();
                            window.tikTokShopGridInitialized = false;
    ...
    return TikTokShopCategoryAttributeValidationPopup;
});
