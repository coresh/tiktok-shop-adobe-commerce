...
namespace M2E\TikTokShop\Block\Adminhtml\General\CreateAttribute;

use M2E\TikTokShop\Block\Adminhtml\Magento\Form\AbstractForm;
use M2E\TikTokShop\Model\Magento\Attribute\Builder as AttributeBuilder;
...
class Form extends AbstractForm
{
    ...
    protected function _prepareForm()
    {
        ...
        $classes = 'validate-length maximum-length-30 TikTokShop-validate-attribute-code ';
        $classes .= 'TikTokShop-validate-attribute-code-to-be-unique';
    ...
    protected function _toHtml()
    {
        ...
        $this->jsPhp->addConstants(
            \M2E\TikTokShop\Helper\Data::getClassConstants(\M2E\TikTokShop\Model\Magento\Attribute\Builder::class)
        );
        ...
        jQuery.validator.addMethod('TikTokShop-validate-attribute-code', function(value, element) {
            return handler.validateAttributeCode(value, element);
        }, TikTokShop.translator.translate('Invalid attribute code'));

        jQuery.validator.addMethod('TikTokShop-validate-attribute-code-to-be-unique', function(value, element) {
            return handler.validateAttributeCodeToBeUnique(value, element);
        }, TikTokShop.translator.translate('Attribute with the same code already exists'));
JS
        );
