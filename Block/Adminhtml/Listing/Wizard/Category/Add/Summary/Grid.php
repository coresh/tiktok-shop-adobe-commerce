...
namespace M2E\TikTokShop\Block\Adminhtml\Listing\Wizard\Category\Add\Summary;

class Grid extends \M2E\TikTokShop\Block\Adminhtml\Category\Grid
{
    /** @var \M2E\TikTokShop\Helper\Module\Database\Structure */
    private $databaseHelper;

    public function __construct(
        \M2E\TikTokShop\Model\ResourceModel\Magento\Category\CollectionFactory $categoryCollectionFactory,
...
HTML;
        ...
        $help = $this->getLayout()->createBlock(\M2E\TikTokShop\Block\Adminhtml\HelpBlock::class)->setData([
...
HTML;
        ...
        if (!$this->getRequest()->getParam('grid')) {
            $this->js->add(
                <<<JS
    require([
        'TikTokShop/Listing/Wizard/Product/Summary/Grid'
    ],function() {
