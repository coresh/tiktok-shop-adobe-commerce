...
class CategorySelectMode extends \M2E\TikTokShop\Block\Adminhtml\Magento\Form\AbstractContainer
{
    use WizardTrait;
    ...
    {
        $this->addChild('form', \M2E\TikTokShop\Block\Adminhtml\Listing\Wizard\Category\ModeSame\Form::class);
