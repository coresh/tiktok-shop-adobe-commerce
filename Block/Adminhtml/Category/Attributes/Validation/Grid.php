...
class Grid extends \M2E\TikTokShop\Block\Adminhtml\Magento\Grid\AbstractGrid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->addFieldToFilter(
            'status',
            \M2E\TikTokShop\Model\Product::STATUS_NOT_LISTED
        );
    ...
    public function getMainButtonsHtml()
    {
        $resetUrl = $this->getUrl(
            '*/tiktokshop_category_attribute_validation/resetValidationData',
            [
        ...
        $button = $this->getLayout()->createBlock(
            ...
            'id' => 'tts_category_validation',
            'label' => __('Validate Attributes'),
            'onclick' => "TikTokShopCategoryAttributeValidatorObj.reValidate('{$resetUrl}');",
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild(
            ...
            )->setTemplate('M2E_TikTokShop::category/attributes/validation.phtml')
        );
    ...
    {
        return $this->getUrl(
            '*/tiktokshop_category_attribute_validation/validate',
            [
                'template_category_id' => $this->templateCategoryId
            ]
        );
    ...
    {
        return $this->getUrl(
            '*/tiktokshop_category_attribute_validation_modal/open',
            [
                'template_category_id' => $this->templateCategoryId
            ]
        );
    ...
    {
        return 'tts_category_attribute_validation_grid_modal';
    }
