    ...
    protected function _prepareForm()
    {
        ...
        $form->addField(
            ...
            [
                'content' => __('<p>This tab of the Account settings contains main configurations ' .
                    ...
                    'import Unmanaged Listings (Items that were Listed on TikTok Shop either directly on the ' .
                    'channel or with the help of other than M2E TikTok Shop Connect tool), automatically link them ' .
        ...
        $fieldset->addField(
            ...
            [
                ...
                'tooltip' => __('Choose whether to import items that have been listed on TikTok Shop ' .
                    'either directly or using a tool other than M2E TikTok Shop Connect. M2E TikTok Shop Connect will ' .
                    'import only active TikTok Shop items.'),
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'tooltip' => __('Choose whether imported TikTok Shop Listings should automatically ' .
        ...
        $fieldset = $form->addFieldset(
            ...
            [
                ...
                'tooltip' => __('<p>In this section you can provide settings for automatic Linking of the ' .
                    ...
                    '<p>The imported Items are linked based on the correspondence between TikTok Shop Item ' .
        ...
        $attributes = $this->magentoAttributeHelper->filterByInputTypes(
            $allAttributes,
            [
                \M2E\TikTokShop\Helper\Magento\Attribute::ATTRIBUTE_FRONTEND_INPUT_TEXT,
                \M2E\TikTokShop\Helper\Magento\Attribute::ATTRIBUTE_FRONTEND_INPUT_TEXTAREA,
                \M2E\TikTokShop\Helper\Magento\Attribute::ATTRIBUTE_FRONTEND_INPUT_SELECT,
            ]
        );
...
HTML
        ...
        $fieldset->addField(
            ...
            [
                ...
                'label' => __('TikTok Shop Product ID'),
                'class' => 'attribute-mode-select',
                'style' => 'float:left; margin-right: 15px;',
                'values' => [
