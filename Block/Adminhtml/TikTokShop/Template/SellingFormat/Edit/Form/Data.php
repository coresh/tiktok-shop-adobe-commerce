...
class Data extends AbstractForm
{
    ...
    protected function _prepareForm(): Data
    {
        ...
        $formData['fixed_price_modifier'] =
            \M2E\TikTokShop\Helper\Json::decode($formData['fixed_price_modifier']) ?: [];
        ...
        $fieldset->addField(
            ...
            [
                ...
                'tooltip' => __('The number of Items you want to sell on TikTok Shop.<br/><br/>' .
                    '<b>Product Quantity:</b> the number of Items on TikTok Shop will be the same as in Magento.<br/>' .
        ...
        $fieldset->addField(
            ...
            [
                ...
                'tooltip' => __('Sets the percentage for calculation of Items number to be Listed ' .
                    'on TikTok Shop basing on Product Quantity or Magento Attribute. E.g., if Quantity Percentage ' .
                    'is set to 10% and Product Quantity is 100, the Quantity to be Listed on TikTok Shop will ' .
        ...
        $fieldset->addField(
            ...
            [
                ...
                'tooltip' => __('Choose whether to limit the amount of Stock you list on TikTok Shop, eg ' .
                    'because you want to set some Stock aside for sales off TikTok Shop.<br/><br/>If this Setting ' .
                    'is <b>Enabled</b> you can specify the maximum Quantity to be Listed. If this Setting ' .
                    'is <b>Disabled</b> all Stock for the Product will be Listed as available on TikTok Shop.'),
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'required' => true,
                'tooltip' => __('If you have 2 pieces in Stock but set a Minimum Quantity to Be Listed of 5, ' .
                    'Item will not be Listed on TikTok Shop.<br/> Otherwise, the Item will be Listed with ' .
        ...
        $fieldset->addField(
            ...
            [
                ...
                'class' => 'TikTokShop-validate-qty',
                'required' => true,
                'tooltip' => __('Set a maximum number to sell on TikTok Shop, e.g. if you ' .
        ...
        $jsMode = \M2E\TikTokShop\Helper\Data::escapeJs($formData['qty_mode']);
        $jsQty = \M2E\TikTokShop\Helper\Data::escapeJs($formData['qty_modification_mode']);
        ...
        if (!empty($formData['fixed_price_modifier'])) {
            $formDataJson = \M2E\TikTokShop\Helper\Json::encode($formData['fixed_price_modifier']);
