...
namespace M2E\TikTokShop\Model\Magento\Tax\Rule;

class Builder extends \M2E\TikTokShop\Model\AbstractModel
{
    public const TAX_CLASS_NAME_PRODUCT = 'M2E TikTok Shop Connect Product Tax Class';
    public const TAX_CLASS_NAME_CUSTOMER = 'M2E TikTok Shop Connect Customer Tax Class';
    public const TAX_CLASS_NAME_SHIPPING = 'M2E TikTok Shop Connect Shipping Tax Class';

    public const TAX_RATE_CODE_PRODUCT = 'M2E TikTok Shop Connect Tax Rate';
    public const TAX_RULE_CODE_PRODUCT = 'M2E TikTok Shop Connect Tax Rule';

    public const TAX_RATE_CODE_SHIPPING = 'M2E TikTok Shop Connect Shipping Tax Rate';
    public const TAX_RULE_CODE_SHIPPING = 'M2E TikTok Shop Connect Shipping Tax Rule';
