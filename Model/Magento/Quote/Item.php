...
use M2E\TikTokShop\Model\Magento\Quote\Total\RoundTaxPercent;

class Item extends \M2E\TikTokShop\Model\AbstractModel
{
    private ?\Magento\Catalog\Model\Product $product = null;
    private ?\Magento\GiftMessage\Model\Message $giftMessage = null;

    private \M2E\TikTokShop\Model\Magento\Tax\Helper $taxHelper;
    ...
    private \M2E\TikTokShop\Model\Order\Item\ProxyObject $proxyItem;
    private \M2E\TikTokShop\Model\Magento\Tax\Rule\BuilderFactory $taxRuleBuilderFactory;
    private \M2E\TikTokShop\Model\Magento\ProductFactory $ourMagentoProductFactory;

    public function __construct(
        \M2E\TikTokShop\Model\Magento\Tax\Rule\BuilderFactory $taxRuleBuilderFactory,
        \M2E\TikTokShop\Model\Magento\ProductFactory $ourMagentoProductFactory,
        \M2E\TikTokShop\Model\Magento\Tax\Helper $taxHelper,
        \Magento\Catalog\Model\ProductFactory $productFactory,
        \Magento\Tax\Model\Calculation $calculation,
        \Magento\GiftMessage\Model\MessageFactory $messageFactory,
        \Magento\Quote\Model\Quote $quote,
        \M2E\TikTokShop\Model\Order\Item\ProxyObject $proxyItem
    ) {
        parent::__construct();
    ...
    public function setTaxClassIntoProduct(
        ...
        if (
            ...
            return $product->setTaxClassId(\M2E\TikTokShop\Model\Magento\Product::TAX_CLASS_ID_NONE);
        }
