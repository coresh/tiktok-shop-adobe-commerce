...
class Repository
{
     ...
     * @return \M2E\TikTokShop\Model\Listing\Wizard\Product[]
     */
    public function findProductsForValidateCategoryAttributes(\M2E\TikTokShop\Model\Listing\Wizard $wizard, int $productLimit): array
    {
        $productCollection = $this->productCollectionFactory->create();
        $productCollection
            ->addFieldToFilter(
    ...
    public function resetCategoryAttributesValidationData(\M2E\TikTokShop\Model\Listing\Wizard $wizard): void
    {
        $this->wizardProductResource
            ->getConnection()
            ->update(
     ...
     * @return int
     */
    public function getProductCount(\M2E\TikTokShop\Model\Listing\Wizard $wizard): int
    {
        $productCollection = $this->productCollectionFactory->create();
        $productCollection
            ->addFieldToFilter(
