...
namespace M2E\TikTokShop\Model\Listing\Wizard\CategoryValidation;

class Validator
{
    /** @var \M2E\TikTokShop\Model\Category\Attribute\ValidateMagentoProduct[] */
    private array $validatorsByCategoryId = [];

    private \M2E\TikTokShop\Model\Listing\Wizard\Manager $wizardManager;
    private \M2E\TikTokShop\Model\Listing\Wizard\Repository $wizardRepository;
    private \M2E\TikTokShop\Model\Category\Attribute\ValidateMagentoProductFactory $validateMagentoProductFactory;

    public function __construct(
        \M2E\TikTokShop\Model\Listing\Wizard\Manager $wizardManager,
        \M2E\TikTokShop\Model\Listing\Wizard\Repository $wizardRepository,
        \M2E\TikTokShop\Model\Category\Attribute\ValidateMagentoProductFactory $validateMagentoProductFactory
    ) {
    ...
    public function processChunk(int $productLimit): Result
    {
        ...
        foreach ($productToValidate as $product) {
            /** @var \M2E\TikTokShop\Model\Category\Dictionary $categoryDictionary */
    ...
    ): \M2E\TikTokShop\Model\Category\Attribute\ValidateMagentoProduct {
