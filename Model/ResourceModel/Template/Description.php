...
class Description extends \M2E\TikTokShop\Model\ResourceModel\ActiveRecord\AbstractModel
{
    ...
    public const COLUMN_RESIZE_IMAGE = 'resize_image';
    ...
    {
        $this->_init(
            \M2E\TikTokShop\Helper\Module\Database\Tables::TABLE_NAME_TEMPLATE_DESCRIPTION,
            self::COLUMN_ID
        );
    }
}
