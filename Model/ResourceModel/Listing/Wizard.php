...
class Wizard extends \M2E\TikTokShop\Model\ResourceModel\ActiveRecord\AbstractModel
{
    ...
    {
        $this->_init(\M2E\TikTokShop\Helper\Module\Database\Tables::TABLE_NAME_LISTING_WIZARD, self::COLUMN_ID);
    }
}
