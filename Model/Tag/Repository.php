...
class Repository
{
    ...
    /** @var \M2E\TikTokShop\Model\Tag\EntityFactory */
    private $entityFactory;

    private $isLoad = false;
    private $entitiesByErrorCode = [];
    private $entitiesById = [];
    /** @var \M2E\TikTokShop\Model\Tag[] */
    private $tags;

    public function __construct(
        \M2E\TikTokShop\Model\TagFactory $tagFactory,
        \M2E\TikTokShop\Model\ResourceModel\Tag\CollectionFactory $collectionFactory,
    ...
    public function create(\M2E\TikTokShop\Model\Tag $tag): void
    {
        if ($this->has($tag)) {
            return;
        }
    ...
    public function has(\M2E\TikTokShop\Model\Tag $tag): bool
    {
        $this->load();
    ...
    /**
     * @return \M2E\TikTokShop\Model\Tag[]
     */
    ...
    public function findEntityById(int $id): ?\M2E\TikTokShop\Model\Tag\Entity
    {
        $this->load();
    ...
    public function findTagByCode(string $code): ?\M2E\TikTokShop\Model\Tag
    {
        $this->load();
