...
class PromotionHandler implements \M2E\TikTokShop\Model\Setup\InstallHandlerInterface
{
    ...
    {
        $tableName = $this->tablesHelper->getFullName(TablesHelper::TABLE_NAME_PROMOTION);
    ...
    {
        $tableName = $this->tablesHelper->getFullName(TablesHelper::TABLE_NAME_PROMOTION_PRODUCT);
