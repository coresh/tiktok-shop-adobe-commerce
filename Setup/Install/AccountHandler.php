...
class AccountHandler implements \M2E\TikTokShop\Model\Setup\InstallHandlerInterface
{
    ...
    {
        $tableName = $this->tablesHelper->getFullName(TablesHelper::TABLE_NAME_SHOP);
    ...
    {
        $tableName = $this->tablesHelper->getFullName(TablesHelper::TABLE_NAME_WAREHOUSE);
