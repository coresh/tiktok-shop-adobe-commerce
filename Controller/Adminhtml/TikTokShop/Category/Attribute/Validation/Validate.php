...
class Validate extends \M2E\TikTokShop\Controller\Adminhtml\TikTokShop\AbstractCategory
{
    private const MAX_PRODUCT_COUNT_FOR_CATEGORY_VALIDATE = 100;

    private \M2E\TikTokShop\Model\Product\Category\Attribute\ValidatorFactory $attributeValidatorFactory;
    private \Magento\Framework\Controller\Result\JsonFactory $jsonResultFactory;

    public function __construct(
        \M2E\TikTokShop\Model\Product\Category\Attribute\ValidatorFactory $attributeValidatorFactory,
