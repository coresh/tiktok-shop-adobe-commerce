...
class GetResponsiblePersonPopupHtml extends \M2E\TikTokShop\Controller\Adminhtml\TikTokShop\AbstractTemplate
{
    ...
    public function execute()
    {
        ...
        $popup = $this->getLayout()->createBlock(
            \M2E\TikTokShop\Block\Adminhtml\TikTokShop\Template\Compliance\ResponsiblePersonPopup::class,
            '',
