...
class GetManufacturerPopupHtml extends \M2E\TikTokShop\Controller\Adminhtml\TikTokShop\AbstractTemplate
{
    ...
    public function execute()
    {
        ...
        $manufacturerPopup = $this->getLayout()->createBlock(
            \M2E\TikTokShop\Block\Adminhtml\TikTokShop\Template\Compliance\ManufacturerPopup::class,
            '',
