...
class GetRuleConditionChooserHtml extends \M2E\TikTokShop\Controller\Adminhtml\AbstractGeneral
{
        ...
        switch ($request->getParam('attribute')) {
            case 'sku':
                $block = $this->getLayout()->createBlock(
                    \M2E\TikTokShop\Block\Adminhtml\Magento\Product\Rule\Chooser\Sku::class,
